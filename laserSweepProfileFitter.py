...
camera=Camera('FAR',200,binx=2,biny=2,imageParams=[0,1024,0,1024],temp=-25)
...
params=spo.curve_fit(voigt,x,y,p0=p0,bounds=bounds)[0]
sigma=params[3]
gamma=params[4]
